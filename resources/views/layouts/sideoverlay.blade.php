<aside id="side-overlay">
      ...
      <div class="bg-primary-op">
        <div class="content-header">
          ...
          <a class="img-link me-1" href="javascript:void(0)">
            <img class="img-avatar img-avatar48" src="https://ui-avatars.com/api/?name={{auth()->user()->username}}" alt="">
          </a>
          <!-- END User Avatar -->

          <!-- User Info -->
          <div class="ms-2">
            <a class="text-white fw-semibold" href="javascript:void(0)">@if(isset(Auth::user()->firstname) && isset(Auth::user()->lastname)) {{Auth::user()->firstname}} {{Auth::user()->lastname}} @else {{Auth::user()->username}} @endif</a>
            <div class="text-white-75 fs-sm">@foreach (Auth::user()->getRoleNames() as $role)
              {{ucfirst($role)}} <br>
            @endforeach</div>
          </div>
          <!-- END User Info -->
    ...
    <div class="content-side">
      <div class="block pull-x mb-0">
        ...
        <!-- Header -->
        <div class="block-content block-content-sm block-content-full bg-body">
          <span class="text-uppercase fs-sm fw-bold">Encabezado</span>
        </div>
        <div class="block-content block-content-full">
