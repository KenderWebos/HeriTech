                    ...
                    <div class="card-body">
                        ...
                        <div class="list-group list-group-flush">
                            @foreach ($ubicaciones as $ubicacion)
                                <button type="button" class="list-group-item list-group-item-action ubicaciones_button"
                                    id="ubicacion_{{ $ubicacion->id }}"
                                    onclick="clickUbicacion({{ $ubicacion->id }})">{{ $ubicacion->nombre }}
                    ...
                    <div class="card-body overflow-auto mb-3" style="height: 18rem;">
                        ...
                        <div class="list-group list-group-flush">
                            @foreach ($eventos as $evento)
                                <button type="button"
                                    class="list-group-item list-group-item-action evento_button ubicacion_{{ $evento->ubicacion->id }}"
                                    id="evento_{{ $evento->id }}"
                                    onclick="clickEvento({{ $evento }},{{ $evento->id_ubicacion }})">{{ $evento->titulo }}</button>
                            @endforeach
                        </div>
                    </div>
                </div>
