            ...
            <div class="card-body">
                <form method="POST" action="{{ route('register.perform') }}">
                    ...
                    <div class="flex flex-col mb-3">
                        <label for="username" class="form-label mb-2"><i class="fa-solid fa-user"></i><span
                                class="ms-2">Nombre de Usuario</span></label>
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-secondary w-100 my-4 mb-2">Registrarse</button>
                    </div>
                    <div class="card-footer text-center pt-0 px-lg-2 px-1">
                        <p class="text-sm mt-3 mb-0">¿Ya tienes una cuenta? <a href="{{ route('login') }}"
                                class="text-primary font-weight-bolder">¡Inicia sesión aquí!</a></p>
