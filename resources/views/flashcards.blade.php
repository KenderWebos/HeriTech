                ...
                <div class="card-list-container">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <p class="card-text answer-div" id="answer-{{ $flashcard->id }}" style="color: {{ $flashcard->answer_visible ? 'inherit' : 'white' }}">✔️: {{ $flashcard->answer }}</p>
                            ...
                            <div class="buttons-con d-flex justify-content-between align-items-center mt-2">
                                ...
                                <form method="POST" action="{{ route('flashcards.destroy', $flashcard) }}" class="ml-2">
                                    @csrf
                                    @method('DELETE')
